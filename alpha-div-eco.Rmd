...
Refer to the [Stack Overflow post](https://stackoverflow.com/questions/60679649/apply-chi-squared-test-in-r-on-more-than-5-variables-and-find-the-p-values) for R coding to implement multivariate chi-squared test. 

```{r chisquared test}
  
# use ... function of ... package to implement chi-square test 

chisq.test(sample_data2_cov2$visitno, sample_data2_cov2$runcenter)
...
```{r plot}
# plot significant correlations with heatmap 
